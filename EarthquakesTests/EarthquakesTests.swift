...
class EarthquakesTests: XCTestCase {
    ...
    func testGeoJSONDecoderDecodesQuake() throws {
        ...
        let decodedTsunamiWarning = quake.tsunami
        let expectedTsnuamiAlert = 0
        
        XCTAssertEqual(decodedTsunamiWarning, expectedTsnuamiAlert)
    }
    ...
    func testGeoJSONDecoderDecodesGeoJSON() throws {
        ...
        let decodedexpectedSeconds = TimeInterval(1636129710550) / 1000
        let decodedSeconds = decoded.quakes[0].time.timeIntervalSince1970
        
        XCTAssertEqual(decodedexpectedSeconds, decodedSeconds)
        
    }
    
    func testQuakeDetailsDecode() throws {
